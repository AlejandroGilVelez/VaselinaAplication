...
namespace Framework.Utilidades
{
    ...
    {
        private const string notificacionContacto = "Vaselina.API.Framework.Resources.EmailTemplate.NotificacionContacto.html";
        ...
        {            
            ...
            mailMessage.Body = new TextPart(TemplateUtils.BodyTemplate(notificacionContacto).Replace("{0}", nombres).Replace("{1}", empresa).Replace("{2}", correo)
                .Replace("{3}", telefono).Replace("{4}", mensaje));
